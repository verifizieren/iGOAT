...
public class ClientHandler implements Runnable {
  ...
  private void handleConnect(String[] params) {
    ...
    if (!requestedNickname.equals(this.nickname)) {
      sendMessage(
          "chat:Dein gewünschter Nickname war bereits vergeben. Neuer Nickname: " + this.nickname);
    }
  ...
  private void handleUsername(String[] params) {
    ...
    if (!requestedNickname.equals(newNickname)) {
      sendMessage(
          "chat:Dein gewünschter Nickname war bereits vergeben. Neuer Nickname: " + newNickname);
    }
