 ...
 * <p>
 * This server:
 * - Accepts TCP connections from game clients
 * - Creates individual ClientHandler threads for each connected client
 * - Manages UDP communication for real-time game state updates
...
public class Server {
     ...
     * Starts the server on either a specified port or the default port.
     *
     ...
     * - Initializes the UDP listener for game state updates
