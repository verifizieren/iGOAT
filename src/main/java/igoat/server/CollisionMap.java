...
/**
 * A class that contains all the collision boxes on the map, which is used on both server
 * and client to ensure correct player movement.
 */
public class CollisionMap {
    private static final Logger logger = LoggerFactory.getLogger(CollisionMap.class);
    ...
    /**
     * Creates a wall with collision components.
     */
    ...
    /**
     * Opens the doors by removing their collision.
     */
