...
public class ChatGUI implements ActionListener {
   ...
   * Sets up the chat window, input field, and message handling.
   */
   ...
   * Continuously checks for new messages and processes them based on their type.
   */
  ...
  /**
   * Processes and sends the message from the input field.
   * Handles both regular chat messages and whisper commands.
   */
